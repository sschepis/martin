import { SHOTSTACK_EFFECTS, SHOTSTACK_FILTERS, SHOTSTACK_TRANSITIONS, SHOTSTACK_RESOLUTIONS } from "./prompts/schemas.js";
    ...
    async pollRenderStatus(renderId) {
        ...
        while (true) {
            ...
            if (status === 'done') {
                ...
                throw new Error(`Shotstack render failed: ${data.response.error}`);
            }
        }
    }
}
